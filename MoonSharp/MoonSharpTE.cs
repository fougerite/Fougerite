...
namespace MoonSharpModule
{
    public class MoonSharpTE
    {
		...
		public delegate void TimedEventFireDelegate(MoonSharpTE evt);

		public event TimedEventFireDelegate OnFire;

		public MoonSharpTE(string name, double interval) {
			this._name = name;
        ...
        public MoonSharpTE(string name, double interval, Dictionary<string, object> args)
			: this(name, interval) {
			this.Args = args;
		}
