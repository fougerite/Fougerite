    ...
    internal class InstaKOCommand : ChatCommand
    {
        ...
        public override void Execute(ref ConsoleSystem.Arg Arguments, ref string[] ChatArguments)
        {
            if (!this.userIDs.Contains(Arguments.argUser.userID))
            {
                ...
                Util.sayUser(Arguments.argUser.networkPlayer, "InstaKO mode has been activated!");
            }
            else
            {
                this.userIDs.Remove(Arguments.argUser.userID);
                Util.sayUser(Arguments.argUser.networkPlayer, "InstaKO mode has been deactivated!");
            }
        }
