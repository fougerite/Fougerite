...
namespace Fougerite.KeyValues
{
    ...
    public sealed class KeyValues : IEquatable<KeyValues>, ICloneable
    {
        ...
        public KeyValues Clone()
        {
            ...
            KV.DistanceFromTop = DistanceFromTop;
            KV.Parent = Parent;
            KV.Comment = Comment;
            KV.NextKeyValueIndex = NextKeyValueIndex;
            KV.NextSubKeyIndex = NextSubKeyIndex;
            KV.KeyChilds = new List<KeyValues>(KeyChilds);
            KV.KeyNameValues = new List<KeyValuesData>(KeyNameValues);
            return KV;
        }
        ...
        public bool LoadFromFile(string fileName)
        {
            ...
            uint endPos = 0;
            return LoadFromList(ReadFileToList(fileName), 0, ref endPos);
        }
        /// <summary>
        ...
        private static void makeTabs(StreamWriter stream, uint num)
        {
